                ...
                <div class="card">
                    <div class="card-body pt-3">
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <!-- Profile Insert Form -->
                            <form action="{{ route('candidate-update', ['id' => $row->id]) }}" method="post"
                                ...
                                <div class="row mb-3">
                                    <label for="summary" class="col-md-4 col-lg-3 col-form-label">Certificate Issue
                                        date</label>
                                    <div class="col-md-8 col-lg-9">
                                        <input type="text" class="form-control" readonly
                                            value="{{ $row->issue_on ?? 'Not Availabe' }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="summary" class="col-md-4 col-lg-3 col-form-label">Certificate Valid
                                        upto</label>
                                    <div class="col-md-8 col-lg-9">
                                        <input type="text" class="form-control" readonly
                                            value="{{ $row->valid_upto ?? 'Not Availabe' }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="summary" class="col-md-4 col-lg-3 col-form-label">Download
                                        Certificate</label>
                                    <div class="col-md-8 col-lg-9">
                                        @if ($row->certificate)
                                            <a href="{{ asset("assets/certificates/$row->certificate") }}"
                                                target="_blank" class="btn btn-primary">Download</a>
                                        @else
                                            <span class="badge bg-danger">Certificate not available!!!</span>
                                        @endif
                                    </div>
                                </div>
